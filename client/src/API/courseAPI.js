...
export const updateCourse = (courseId, courseData) =>API.put(`/course/${courseId}`, courseData);
export const getEnrolledCourses = (courseId) => API.get(`/course/getEnrolledCourses/${courseId}`);
export const acceptStudent = (courseId, studentId) =>
  API.post(`/course/accept/${courseId}/${studentId}`);